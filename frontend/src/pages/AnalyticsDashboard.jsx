...
const AnalyticsDashboard = () => {
  ...
  const [riskRadarData, setRiskRadarData] = useState([
    { subject: 'Enrollment', A: 65, fullMark: 100 },
    ...
    { subject: 'Timeline', A: 72, fullMark: 100 }
  ])
        ...
        <div className="p-6">
          {activeModule === 'overview' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg border">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={trialProgressData}>
              ...
              {/* Risk Radar */}
              <div className="bg-white p-6 rounded-lg border">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Risk Assessment Radar</h3>
                <ResponsiveContainer width="100%" height={400}>
                  <RadarChart data={riskRadarData}>
                    <PolarGrid />
                    <PolarAngleAxis dataKey="subject" />
                    <PolarRadiusAxis angle={90} domain={[0, 100]} />
                    <Radar name="Risk Score" dataKey="A" stroke="#3B82F6" fill="#3B82F6" fillOpacity={0.6} />
                  </RadarChart>
                </ResponsiveContainer>
              </div>
            </div>
              ...
              <div className="bg-white p-6 rounded-lg border">
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart data={devicePerformanceData}>
                    ...
                    <Bar dataKey="procedures" fill="#10B981" />
